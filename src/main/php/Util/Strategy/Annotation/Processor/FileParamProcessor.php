...
use Itspire\FrameworkExtraBundle\Util\Strategy\Attribute\Processor\FileParamProcessor as AttributeFileParamProcessor;

/** @deprecated */
class FileParamProcessor extends AttributeFileParamProcessor implements AnnotationProcessorInterface
{
