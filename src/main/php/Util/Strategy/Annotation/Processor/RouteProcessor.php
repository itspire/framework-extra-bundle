...
use Itspire\FrameworkExtraBundle\Util\Strategy\Attribute\Processor\RouteProcessor as AttributeRouteProcessor;

/** @deprecated */
class RouteProcessor extends AttributeRouteProcessor implements AnnotationProcessorInterface
{
