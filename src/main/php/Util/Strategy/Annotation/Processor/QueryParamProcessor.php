...
use Itspire\FrameworkExtraBundle\Util\Strategy\Attribute\Processor\QueryParamProcessor as AttributeQueryParamProcessor;

/** @deprecated */
class QueryParamProcessor extends AttributeQueryParamProcessor implements AnnotationProcessorInterface
{
