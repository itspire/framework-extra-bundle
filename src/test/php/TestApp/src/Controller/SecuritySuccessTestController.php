...
#[ItspireFrameworkExtra\Route(path: '/security/success', methods: HttpMethod::GET)]
#[ItspireFrameworkExtra\Security(expression: 'true', responseStatus: HttpResponseStatus::HTTP_FORBIDDEN)]
class SecuritySuccessTestController extends AbstractController
{
    #[ItspireFrameworkExtra\Route(path: '', name: 'securitySuccessTest')]
    public function securitySuccessTest(): Response
    {
